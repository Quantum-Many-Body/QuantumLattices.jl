...
function _precompile_()
    ...
    Base.precompile(Tuple{Type{Term{:Hopping, id, V, Int64} where {id, V}},Symbol,Float64,Int64})
    Base.precompile(Tuple{Type{Term{:Hubbard, id, V, Int64} where {id, V}},Symbol,Float64})
    ...
    Base.precompile(Tuple{typeof(QuantumLattices.Prerequisites.Traits._parametertype),Type{OperatorPack{Int64, Tuple{CompositeIID{Tuple{FID{:*, Symbol, Symbol, Symbol}, FID{:*, Symbol, Symbol, Symbol}}}, Subscripts{Tuple{NamedTuple{(:orbital, :spin), Tuple{Subscript{Tuple{Symbol, Symbol}, typeof(diagonal)}, Subscript{Tuple{Symbol, Symbol}, typeof(diagonal)}}}}, Tuple{Pair{UnitRange{Int64}, Tuple{String, String}}}}}}},Val{2}})
    ...
    if !ismissing(fbody)
        precompile(fbody, (Base.Pairs{Symbol, V, Tuple{Vararg{Symbol, N}}, NamedTuple{names, T}} where {V, N, names, T<:Tuple{Vararg{Any, N}}},typeof(replace),Term,))
    end
end
end
