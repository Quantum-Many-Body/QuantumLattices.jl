...
function _precompile_()
    ...
    Base.precompile(Tuple{QuantumLattices.Essentials.DegreesOfFreedom.var"##s195#44",Any,Any,Any})
    ...
    Base.precompile(Tuple{typeof(children),SimpleTree{LatticeBonds, Nothing},QuantumLattices.Essentials.Spatials.AllBonds})
