...
{
    "location": "man/Interfaces.html#QuantumLattices.Interfaces.reset!",
    "page": "Interfaces",
    "title": "QuantumLattices.Interfaces.reset!",
    "category": "function",
    "text": "Inplace reset.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/CompositeStructures.html#NamedContainer-1",
    "page": "Composite structures",
    "title": "NamedContainer",
    "category": "section",
    "text": "NamedContainer is just a wrapper (type alias) of Julia NamedTuple, but not a composite type.Julia NamedTuple is useful to keep type stability of codes when we deal with unhomogenous immutable dict-like objects, but its default constructor is not so convenient becase the names and contents must be assigned pair by pair in a pair of parentheses explicitly. Therefore, we define a type alias of NamedTuple under the name of NamedContainer, so that we can construct a NamedTuple by the usual-formed constructor NamedContainer."
},
...
{
    "location": "man/Prerequisites/CompositeStructures.html#QuantumLattices.Prerequisites.CompositeStructures.NamedContainer",
    "page": "Composite structures",
    "title": "QuantumLattices.Prerequisites.CompositeStructures.NamedContainer",
    "category": "type",
    "text": "NamedContainer{T,Names}=NamedTuple{Names,<:Tuple{Vararg{T}}}\n\nNamedContainer is just a wrapper of Julia NamedTuple, but not a composite type.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/CompositeStructures.html#QuantumLattices.Prerequisites.CompositeStructures.NamedContainer-Union{Tuple{Names}, Tuple{Any,Vararg{Any,N} where N}} where Names",
    "page": "Composite structures",
    "title": "QuantumLattices.Prerequisites.CompositeStructures.NamedContainer",
    "category": "method",
    "text": "NamedContainer{Names}(contents...) where Names -> NamedTuple{Names,typeof(contents)}\n\nConstruct a named container.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.addnode!-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.addnode!",
    "category": "method",
    "text": "addnode!(tree::AbstractSimpleTree{N},node::N) where N} -> typeof(tree)\naddnode!(tree::AbstractSimpleTree{N},::Nothing,node::N) where N -> typeof(tree)\naddnode!(tree::AbstractSimpleTree{N},parent::N,node::N) where N -> typeof(tree)\n\nUpdate the structure of a tree by adding a node. When the parent is nothing, the input tree must be empty and the input node becomes the tree\'s root.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.ancestor-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}, Tuple{AbstractSimpleTree{N,D} where D,N,Int64}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.ancestor",
    "category": "method",
    "text": "ancestor(tree::AbstractSimpleTree{N},node::N,generation::Int=1) where N -> N\n\nGet the ancestor of a tree\'s node of the n-th generation.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.deletenode!-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.deletenode!",
    "category": "method",
    "text": "deletenode!(tree::AbstractSimpleTree{N},node::N) where N -> typeof(tree)\n\nUpdate the structure of a tree by deleting a node.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.descendants-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}, Tuple{AbstractSimpleTree{N,D} where D,N,Int64}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.descendants",
    "category": "method",
    "text": "descendants(tree::AbstractSimpleTree{N},node::N,generation::Int=1) where N -> Vector{N}\n\nGet the descendants of a tree\'s node of the n-th generation.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.isleaf-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.isleaf",
    "category": "method",
    "text": "isleaf(tree::AbstractSimpleTree{N},node::N) where N -> Bool\n\nJudge whether a tree\'s node is a leaf (a node without children) or not.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.level-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.level",
    "category": "method",
    "text": "level(tree::AbstractSimpleTree{N},node::N) where N -> Int\n\nGet the level of tree\'s node.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.move!-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N,N}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.move!",
    "category": "method",
    "text": "move!(tree::AbstractSimpleTree{N},node::N,parent::N) where N -> typeof(tree)\n\nMove a subtree to a new position.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.parent-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}, Tuple{AbstractSimpleTree{N,D} where D,N,Union{Nothing, N}}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.parent",
    "category": "method",
    "text": "parent(tree::AbstractSimpleTree{N},node::N,superparent::Union{N,Nothing}=nothing) where N -> Union{N,Nothing}\n\nGet the parent of a tree\'s node. When node is the tree\'s root, return superparent.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.siblings-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.siblings",
    "category": "method",
    "text": "siblings(tree::AbstractSimpleTree{N},node::N) where N -> Vector{N}\n\nGet the siblings (other nodes sharing the same parent) of a tree\'s node.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/SimpleTrees.html#QuantumLattices.Prerequisites.SimpleTrees.subtree-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "QuantumLattices.Prerequisites.SimpleTrees.subtree",
    "category": "method",
    "text": "subtree(tree::AbstractSimpleTree{N},node::N) where N -> typeof(tree)\n\nGet a subtree whose root is node.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/SimpleTrees.html#Base.delete!-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "Base.delete!",
    "category": "method",
    "text": "delete!(tree::AbstractSimpleTree{N},node::N) where N -> typeof(tree)\n\nDelete a node and all its descendants from a tree.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/SimpleTrees.html#Base.getindex-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "Base.getindex",
    "category": "method",
    "text": "getindex(tree::AbstractSimpleTree{N},node::N) where N -> N\n\nGet the data of a tree\'s node.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/SimpleTrees.html#Base.haskey-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,N}} where N",
    "page": "Simple trees",
    "title": "Base.haskey",
    "category": "method",
    "text": "haskey(tree::AbstractSimpleTree{N},node::N) where N -> Bool\n\nCheck whether a node is in a tree.\n\n\n\n\n\n"
},

{
    "location": "man/Prerequisites/SimpleTrees.html#Base.keys-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,SimpleTreeIteration}, Tuple{AbstractSimpleTree{N,D} where D,SimpleTreeIteration,Union{Nothing, N}}} where N",
    "page": "Simple trees",
    "title": "Base.keys",
    "category": "method",
    "text": "keys(tree::AbstractSimpleTree{N},::SimpleTreeDepth,node::Union{N,Nothing}=tree|>root) where N\nkeys(tree::AbstractSimpleTree{N},::SimpleTreeWidth,node::Union{N,Nothing}=tree|>root) where N\n\nIterate over a tree\'s nodes starting from a certain node by depth first search or width first search.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/SimpleTrees.html#Base.pairs-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,SimpleTreeIteration}, Tuple{AbstractSimpleTree{N,D} where D,SimpleTreeIteration,Union{Nothing, N}}} where N",
    "page": "Simple trees",
    "title": "Base.pairs",
    "category": "method",
    "text": "pairs(tree::AbstractSimpleTree{N},::SimpleTreeDepth,node::Union{N,Nothing}=tree|>root) where N\npairs(tree::AbstractSimpleTree{N},::SimpleTreeWidth,node::Union{N,Nothing}=tree|>root) where N\n\nIterate over a tree\'s (node,data) pairs starting from a certain node by depth first search or width first search.\n\n\n\n\n\n"
},
...
{
    "location": "man/Prerequisites/SimpleTrees.html#Base.values-Union{Tuple{N}, Tuple{AbstractSimpleTree{N,D} where D,SimpleTreeIteration}, Tuple{AbstractSimpleTree{N,D} where D,SimpleTreeIteration,Union{Nothing, N}}} where N",
    "page": "Simple trees",
    "title": "Base.values",
    "category": "method",
    "text": "values(tree::AbstractSimpleTree{N},::SimpleTreeDepth,node::Union{N,Nothing}=tree|>root) where N\nvalues(tree::AbstractSimpleTree{N},::SimpleTreeWidth,node::Union{N,Nothing}=tree|>root) where N\n\nIterate over a tree\'s data starting from a certain node by depth first search or width first search.\n\n\n\n\n\n"
},
...
{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Mathematics.AlgebraOverFields.ScalarElement",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.ScalarElement",
    "category": "type",
    "text": "ScalarElement{V}\n\nIdentity element.\n\n\n\n\n\n"
},
...
{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Mathematics.AlgebraOverFields.idtype-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.Element}",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.idtype",
    "category": "method",
    "text": "idtype(m::Element)\nidtype(::Type{<:Element{V,I} where V}) where I<:ID\nidtype(::Type{<:Element})\n\nThe type of the id of an element.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Mathematics.AlgebraOverFields.rawelement-Tuple{Type{#s21} where #s21<:QuantumLattices.Mathematics.AlgebraOverFields.Element}",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.rawelement",
    "category": "method",
    "text": "rawelement(::Type{<:Element})\n\nGet the raw name of a type of Element.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.:*-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.Element,Nothing}",
    "page": "Algebra over fields",
    "title": "Base.:*",
    "category": "method",
    "text": "*(factor,m::Element) -> Element\n*(m::Element,factor) -> Element\n*(m1::Element,m2::Element) -> Element\n*(m::Element,::Nothing) -> Nothing\n*(::Nothing,m::Element) -> Nothing\n*(factor,ms::Elements) -> Elements\n*(ms::Elements,factor) -> Elements\n*(m::Element,ms::Elements) -> Elements\n*(ms::Elements,m::Element) -> Elements\n*(ms1::Elements,ms2::Elements) -> Elements\n*(ms::Elements,::Nothing) -> Nothing\n*(::Nothing,ms::Elements) -> Nothing\n\nOverloaded * operator for element-scalar multiplications and element-element multiplications of an algebra over a field.\n\n\n\n\n\n"
},
...
{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.:/-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.Element,Any}",
    "page": "Algebra over fields",
    "title": "Base.:/",
    "category": "method",
    "text": "/(m::Element,factor) -> Element\n/(m::Element,factor::ScalarElement) -> Element\n/(ms::Elements,factor) -> Elements\n/(ms::Elements,factor::ScalarElement) -> Elements\n\nOverloaded / operator for element-scalar division of an algebra over a field.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.:==-Tuple{Dict{I,M} where M<:QuantumLattices.Mathematics.AlgebraOverFields.Element where I<:QuantumLattices.Mathematics.AlgebraOverFields.ID,Nothing}",
    "page": "Algebra over fields",
    "title": "Base.:==",
    "category": "method",
    "text": "==(ms::Elements,::Nothing) -> Bool\n==(::Nothing,ms::Elements) -> Bool\nisequal(ms::Elements,::Nothing) -> Bool\nisequal(::Nothing,ms::Elements) -> Bool\n\n\n\n\n\n"
},
...

{
    ...
    "title": "Base.:^",
    "category": "method",
    "text": "^(m::Element,n::Int) -> Element\n^(ms::Elements,n::Int) -> Elements\n\nOverloaded ^ operator for element-integer power of an algebra over a field.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.convert-Union{Tuple{M}, Tuple{Type{M},Element{V,ID{Tuple{}}} where V}} where M<:(QuantumLattices.Mathematics.AlgebraOverFields.Element{V,QuantumLattices.Mathematics.AlgebraOverFields.ID{Tuple{}}} where V)",
    "page": "Algebra over fields",
    "title": "Base.convert",
    "category": "method",
    "text": "convert(::Type{M},m::ScalarElement) where {M<:ScalarElement}\nconvert(::Type{M},m) where {M<:ScalarElement}\nconvert(::Type{M},m::Element) where {M<:Element}\n\nConvert a scalar element from one type to another;\nConvert a scalar to a scalar element;\nConvert an element from one type to another.\n\n\n\n\n\n"
},
...
{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.one-Union{Tuple{Type{M}}, Tuple{M}} where M<:QuantumLattices.Mathematics.AlgebraOverFields.Element",
    "page": "Algebra over fields",
    "title": "Base.one",
    "category": "method",
    "text": "one(::Type{M}) where {M<:Element}\n\nGet the identity operator.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.permute!",
    "page": "Algebra over fields",
    "title": "Base.permute!",
    "category": "function",
    "text": "permute!(result::Elements,m::Element,table=nothing) -> Elements\npermute!(result::Elements,ms::Elements,table=nothing) -> Elements\n\nPermute the ids of an-element/a-set-of-elements to the descending order according to a table, and store the permuted elements in result.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.promote_rule-Union{Tuple{I2}, Tuple{I1}, Tuple{Type{I1},Type{I2}}} where I2<:QuantumLattices.Mathematics.AlgebraOverFields.ID where I1<:QuantumLattices.Mathematics.AlgebraOverFields.ID",
    "page": "Algebra over fields",
    "title": "Base.promote_rule",
    "category": "method",
    "text": "promote_rule(::Type{I1},::Type{I2}) where {I1<:ID,I2<:ID}\n\nDefine the promote rule for ID types.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.promote_rule-Union{Tuple{M2}, Tuple{M1}, Tuple{Type{M1},Type{M2}}} where M2<:QuantumLattices.Mathematics.AlgebraOverFields.Element where M1<:QuantumLattices.Mathematics.AlgebraOverFields.Element",
    "page": "Algebra over fields",
    "title": "Base.promote_rule",
    "category": "method",
    "text": "promote_rule(::Type{M1},::Type{M2}) where {M1<:Element,M2<:Element}\n\nDefine the promote rule for Element types.\n\n\n\n\n\n"
},
...
{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.split-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.Element}",
    "page": "Algebra over fields",
    "title": "Base.split",
    "category": "method",
    "text": "split(m::Element) -> Tuple{Any,Vararg{Element}}\n\nSplit an element into the coefficient and a sequence of rank-1 elements.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#Base.valtype-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.Element}",
    "page": "Algebra over fields",
    "title": "Base.valtype",
    "category": "method",
    "text": "valtype(m::Element)\nvaltype(::Type{<:Element})\nvaltype(::Type{<:Element{V}}) where V\n\nGet the type of the value of an element.\n\nThe result is also the type of the field over which the algebra is defined.\n\n\n\n\n\n"
},
...
{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Interfaces.div!-Tuple{Dict{I,M} where M<:QuantumLattices.Mathematics.AlgebraOverFields.Element where I<:QuantumLattices.Mathematics.AlgebraOverFields.ID,QuantumLattices.Mathematics.AlgebraOverFields.Element{V,QuantumLattices.Mathematics.AlgebraOverFields.ID{Tuple{}}} where V}",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Interfaces.div!",
    "category": "method",
    "text": "div!(ms::Elements,factor::ScalarElement) -> Elements\ndiv!(ms::Elements,factor) -> Elements\n\nGet the inplace division of element with a scalar.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Interfaces.mul!-Tuple{Dict{I,M} where M<:QuantumLattices.Mathematics.AlgebraOverFields.Element where I<:QuantumLattices.Mathematics.AlgebraOverFields.ID,QuantumLattices.Mathematics.AlgebraOverFields.Element{V,QuantumLattices.Mathematics.AlgebraOverFields.ID{Tuple{}}} where V}",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Interfaces.mul!",
    "category": "method",
    "text": "mul!(ms::Elements,factor::ScalarElement) -> Elements\nmul!(ms::Elements,factor) -> Elements\n\nGet the inplace multiplication of elements with a scalar.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Interfaces.permute",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Interfaces.permute",
    "category": "function",
    "text": "permute(m::Element,table=nothing) -> Elements\npermute(ms::Elements,table=nothing) -> Elements\n\nPermute the ids of an-element/a-set-of-elements to the descending order according to a table.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Interfaces.rank-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.Element}",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Interfaces.rank",
    "category": "method",
    "text": "rank(m::Element) -> Int\nrank(::Type{M}) where M<:Element -> Int\n\nGet the rank of an element.\n\n\n\n\n\n"
},

{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Interfaces.rank-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.ID}",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Interfaces.rank",
    "category": "method",
...
{
    "location": "man/Mathematics/AlgebraOverFields.html#QuantumLattices.Interfaces.sequence-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.Element,Any}",
    "page": "Algebra over fields",
    "title": "QuantumLattices.Interfaces.sequence",
    "category": "method",
    "text": "sequence(m::Element,table=nothing) -> NTuple{rank(m),Int}\n\nGet the sequence of the ids of an element according to a table.\n\n\n\n\n\n"
},
...
{
    "location": "man/Mathematics/QuantumNumbers.html#Base.eltype-Union{Tuple{Type{#s21} where #s21<:AbelianNumbers{QN}}, Tuple{QN}} where QN<:QuantumLattices.Mathematics.QuantumNumbers.AbelianNumber",
    "page": "Quantum numbers",
    "title": "Base.eltype",
    "category": "method",
    "text": "eltype(::Type{<:AbelianNumbers{QN}}) where {QN<:AbelianNumber}\neltype(qns::AbelianNumbers)\n\nGet the type of the concrete AbelianNumber contained in a AbelianNumbers.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Spatials.html#Bonds-1",
    "page": "Spatials",
    "title": "Bonds",
    "category": "section",
    "text": ""
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.azimuth-Tuple{AbstractArray{#s266,1} where #s266<:Real}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.azimuthd-Tuple{AbstractArray{#s266,1} where #s266<:Real}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.bondtypes-Tuple{Bonds}",
    "page": "Spatials",
    "title": "QuantumLattices.Essentials.Spatials.bondtypes",
    "category": "method",
    "text": "bondtypes(bs::Bonds) -> Tuple{Vararg{LatticeBonds}}\nbondtypes(::Type{<:Bonds{T}}) where T -> Tuple{Vararg{LatticeBonds}}\n\nGet the bondtypes of a set of lattice bonds.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.distance-Tuple{AbstractArray{#s255,1} where #s255<:Real,AbstractArray{#s22,1} where #s22<:Real}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.interlinks-Tuple{AbstractArray{#s276,2} where #s276<:Real,AbstractArray{#s275,2} where #s275<:Real,Dict{Int64,Float64}}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.intralinks-Union{Tuple{N}, Tuple{AbstractArray{#s271,2} where #s271<:Real,AbstractArray{#s270,1} where #s270<:(AbstractArray{#s269,1} where #s269<:Real),Dict{Int64,Float64}}, Tuple{AbstractArray{#s268,2} where #s268<:Real,AbstractArray{#s267,1} where #s267<:(AbstractArray{#s266,1} where #s266<:Real),Dict{Int64,Float64},Tuple{Vararg{Int64,N}}}} where N",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.issubordinate-Tuple{AbstractArray{#s274,1} where #s274<:Real,AbstractArray{#s273,1} where #s273<:(AbstractArray{#s272,1} where #s272<:Real)}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.latticebondsstructure-Tuple{Type{#s281} where #s281<:AbstractLattice}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.latticebondsstructure-Tuple{Type{#s343} where #s343<:SuperLattice}",
    "page": "Spatials",
    "title": "QuantumLattices.Essentials.Spatials.latticebondsstructure",
    "category": "method",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.latticetype-Tuple{Bonds}",
    "page": "Spatials",
    "title": "QuantumLattices.Essentials.Spatials.latticetype",
    "category": "method",
    "text": "latticetype(bs::Bonds)\nlatticetype(::Type{<:Bonds{T,L} where T}) where L<:AbstractLattice\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.latticetype-Tuple{SuperLattice}",
    "page": "Spatials",
    "title": "QuantumLattices.Essentials.Spatials.latticetype",
    "category": "method",
    "text": "latticetype(sl::SuperLattice)\nlatticetype(::Type{<:SuperLattice{L}}) where L<:AbstractLattice\n\nGet the sublattice type of a superlattice.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.polar-Tuple{AbstractArray{#s266,1} where #s266<:Real}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.polard-Tuple{AbstractArray{#s266,1} where #s266<:Real}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.reciprocals-Tuple{AbstractArray{#s281,1} where #s281<:(AbstractArray{#s280,1} where #s280<:Real)}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.rotate-Tuple{AbstractArray{#s268,2} where #s268<:Real,Real}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.tile-Union{Tuple{M}, Tuple{N}, Tuple{AbstractArray{#s271,2} where #s271<:Real,AbstractArray{#s270,1} where #s270<:(AbstractArray{#s269,1} where #s269<:Real)}, Tuple{AbstractArray{#s268,2} where #s268<:Real,AbstractArray{#s267,1} where #s267<:(AbstractArray{#s266,1} where #s266<:Real),Tuple{Vararg{Tuple{Vararg{#s262,N}} where #s262<:Real,M}}}} where M where N",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.translate-Tuple{AbstractArray{#s282,2} where #s282<:Real,AbstractArray{#s281,1} where #s281<:Real}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Essentials.Spatials.volume-Tuple{AbstractArray{#s255,1} where #s255<:Real,AbstractArray{#s22,1} where #s22<:Real,AbstractArray{#s21,1} where #s21<:Real}",
    "page": "Spatials",
...
{
    "location": "man/Essentials/Spatials.html#Base.empty!-Tuple{Bonds}",
    "page": "Spatials",
    "title": "Base.empty!",
    "category": "method",
    "text": "empty!(bs::Bonds) -> Bonds\n\nEmpty a set of lattice bonds.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Spatials.html#Base.getindex-Tuple{Bonds,Int64}",
    "page": "Spatials",
    "title": "Base.getindex",
    "category": "method",
    "text": "getindex(bs::Bonds,i::Int) -> eltype(bs)\n\nGet the ith bond in the set.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Spatials.html#Base.size-Tuple{Bonds}",
    "page": "Spatials",
    "title": "Base.size",
    "category": "method",
    "text": "size(bs::Bonds) -> Tuple{Int}\n\nGet the size of the set of lattice bonds.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Interfaces.decompose-Tuple{AbstractArray{#s268,1} where #s268<:Real,AbstractArray{#s267,1} where #s267<:Real}",
    "page": "Spatials",
    "title": "QuantumLattices.Interfaces.decompose",
    "category": "method",
...
{
    "location": "man/Essentials/Spatials.html#QuantumLattices.Interfaces.reset!-Tuple{Bonds,AbstractLattice}",
    "page": "Spatials",
    "title": "QuantumLattices.Interfaces.reset!",
    "category": "method",
    "text": "reset!(bs::Bonds,lattice::AbstractLattice) -> Bonds\n\nReset a set of lattice bonds by a new lattice.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#Boundary-1",
    "page": "Degrees of freedom",
    "title": "Boundary",
    "category": "section",
    "text": ""
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Essentials.DegreesOfFreedom.coordabsent",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.coordabsent",
    "category": "constant",
    "text": "coordabsent\n\nIndicate that the :icoord and :rcoord attributes in an oid should be nothing\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Essentials.DegreesOfFreedom.coordpresent",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.coordpresent",
    "category": "constant",
...

{
    ...
    "category": "type",
    "text": "Operator{V,I<:ID} <: Element{V,I}\n\nAbstract type for an operator.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "type",
    "text": "Table{I}(by::IndexToTuple) where I<:Index\n\nIndex-sequence table.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Essentials.DegreesOfFreedom.isHermitian-Union{Tuple{ID{#s346} where #s346<:Tuple{Vararg{OID,N}}}, Tuple{N}} where N",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.isHermitian",
    "category": "method",
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Essentials.DegreesOfFreedom.oidtype-Tuple{Type{#s346} where #s346<:IID,Type{#s343} where #s343<:AbstractBond,Type{Nothing},Val{true}}",
    "page": "Degrees of freedom",
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Essentials.DegreesOfFreedom.twist-Tuple{Operator,AbstractArray{#s347,1} where #s347<:AbstractArray{Float64,1},AbstractArray{Float64,1}}",
    "page": "Degrees of freedom",
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#Base.:==-Tuple{Boundary,Boundary}",
    "page": "Degrees of freedom",
    "title": "Base.:==",
    "category": "method",
    "text": "==(bound1::Boundary,bound2::Boundary) -> Bool\nisequal(bound1::Boundary,bound2::Boundary) -> Bool\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#Base.angle-Tuple{Boundary,Operator}",
    "page": "Degrees of freedom",
    "title": "Base.angle",
    "category": "method",
    "text": "angle(bound::Boundary,operator::Operator) -> Float\nangle(bound::Boundary{()},operator::Operator) -> Int\n\nGet the boundary twist phase of an operator.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/DegreesOfFreedom.html#Base.angle-Tuple{QuantumLattices.Mathematics.AlgebraOverFields.ID{#s342} where #s342<:Tuple{Vararg{OID,N} where N},AbstractArray{#s284,1} where #s284<:AbstractArray{Float64,1},AbstractArray{Float64,1}}",
    "page": "Degrees of freedom",
    "title": "Base.angle",
    "category": "method",
    "text": "angle(id::ID{<:Tuple{Vararg{OID}}},vectors::AbstractVector{<:AbstractVector{Float}},values::AbstractVector{Float}) -> Float\n\nGet the total twist phase of an id.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#Base.reverse-Tuple{Table}",
    "page": "Degrees of freedom",
    "title": "Base.reverse",
    "category": "method",
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#Base.union-Tuple{Vararg{Table,N} where N}",
    "page": "Degrees of freedom",
    "title": "Base.union",
    "category": "method",
    "text": "union(tables::Table...) -> Table\n\nUnite several index-sequence tables.\n\nSee Table for more details.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Essentials.Spatials.icoord-Tuple{Operator}",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Essentials.Spatials.icoord",
    "category": "method",
    "text": "icoord(opt::Operator) -> SVector\n\nGet the whole icoord of an operator.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Essentials.Spatials.rcoord-Tuple{Operator}",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Essentials.Spatials.rcoord",
    "category": "method",
    "text": "rcoord(opt::Operator) -> SVector\n\nGet the whole rcoord of an operator.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Interfaces.reset!-Tuple{IDFConfig,Any}",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Interfaces.reset!",
    "category": "method",
    "text": "reset!(config::IDFConfig,pids) -> IDFConfig\n\nReset the idfconfig with new pids.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Interfaces.reset!-Tuple{Table,AbstractArray{#s346,1} where #s346<:Index}",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Interfaces.reset!",
    "category": "method",
    "text": "reset!(table::Table,indices::AbstractVector{<:Index}) -> Table\nreset!(table::Table,config::IDFConfig) -> Table\n\nReset a table.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Interfaces.sequence",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Interfaces.sequence",
    "category": "function",
    "text": "sequence(opt::Operator,table=nothing) -> NTuple{rank(opt),Int}\n\nGet the sequence of the oids of an operator according to a table.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/DegreesOfFreedom.html#QuantumLattices.Mathematics.AlgebraOverFields.rawelement-Tuple{Type{#s347} where #s347<:Operator}",
    "page": "Degrees of freedom",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.rawelement",
    "category": "method",
    "text": "rawelement(::Type{<:Operator})\n\nGet the raw name of a type of Operator.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "type",
    "text": "Couplings(cps::Coupling...)\n\nA pack of couplings intra/inter interanl degrees of freedom at different lattice points.\n\nAlias for Elements{<:ID,<:Coupling}.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Terms.html#QuantumLattices.Essentials.Terms.GenOperators",
    "page": "Terms",
    "title": "QuantumLattices.Essentials.Terms.GenOperators",
    "category": "type",
    "text": "GenOperators(constops::Operators,alterops::NamedContainer{Operators},boundops::NamedContainer{Operators})\n\nA set of operators. This is the core of Generator.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Terms.html#QuantumLattices.Essentials.Terms.Generator",
    "page": "Terms",
    "title": "QuantumLattices.Essentials.Terms.Generator",
    "category": "type",
    "text": "Generator{coord}(   terms::Tuple{Vararg{Term}},bonds::Bonds,config::IDFConfig,\n                    table::Union{Nothing,Table}=nothing,\n                    half::Bool=true,\n                    boundary::Boundary=Boundary(),\n                    ) where coord\n\nA generator of operators based on terms, configuration of internal degrees of freedom, table of indices and boundary twist.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Terms.html#QuantumLattices.Essentials.Terms.Parameters",
    "page": "Terms",
    "title": "QuantumLattices.Essentials.Terms.Parameters",
    "category": "type",
    "text": "Parameters{Names}(values::Number...) where Names\n\nA NamedTuple that contain the key-value pairs.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Terms.html#QuantumLattices.Essentials.Terms.Parameters-Tuple{Generator}",
    "page": "Terms",
    "title": "QuantumLattices.Essentials.Terms.Parameters",
    "category": "method",
    "text": "Parameters(gen::Generator) -> Parameters\n\nGet the parameters of the terms of a generator.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "type",
    "text": "Term{ST,K,R,I}(value::Any,bondkind::Any,couplings::TermCouplings,amplitude::TermAmplitude,modulate::Union{TermModulate,Nothing},factor::Any) where {ST,K,R,I}\nTerm{ST,K,R}(  id::Symbol,value::Any,bondkind::Any;\n                couplings::Union{Function,Coupling,Couplings,TermCouplings},\n                amplitude::Union{Function,Nothing}=nothing,\n                modulate::Union{Function,Bool}=false,\n                ) where {ST,K,R}\n\nA term of a quantum lattice system.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Terms.html#Base.:==-Tuple{GenOperators,GenOperators}",
    "page": "Terms",
    "title": "Base.:==",
    "category": "method",
    "text": "==(genops1::GenOperators,genops2::GenOperators) -> Bool\nisequal(genops1::GenOperators,genops2::GenOperators) -> Bool\n\nJudge whether two sets of operators are equivalent to each other.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Terms.html#Base.:==-Tuple{Generator,Generator}",
    "page": "Terms",
    "title": "Base.:==",
    "category": "method",
    "text": "==(gen1::Generator,gen2::Generator) -> Bool\nisequal(gen1::Generator,gen2::Generator) -> Bool\n\nJudge whether generators are equivalent to each other.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Terms.html#Base.empty-Union{Tuple{Generator{coord,TS,BS,C,T,B,OS} where OS<:GenOperators where B<:Boundary where T<:Union{Nothing, Table} where C<:IDFConfig where BS<:Bonds where TS<:(NamedTuple{Names,#s22} where #s22<:Tuple{Vararg{Term,N} where N} where Names)}, Tuple{coord}} where coord",
    "page": "Terms",
    "title": "Base.empty",
    "category": "method",
    "text": "empty(gen::Generator{coord}) where coord -> Generator\n\nGet an empty copy of a generator.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Terms.html#Base.replace-Union{Tuple{Term{ST,K,R,I,V,B,C,A,M} where M<:Union{Nothing, TermModulate} where A<:TermAmplitude where C<:TermCouplings where B where V}, Tuple{I}, Tuple{R}, Tuple{K}, Tuple{ST}} where I where R where K where ST",
    "page": "Terms",
    "title": "Base.replace",
    "category": "method",
...
{
    "location": "man/Essentials/Terms.html#QuantumLattices.Interfaces.expand!-Tuple{Dict{I,O} where O<:Operator where I<:QuantumLattices.Mathematics.AlgebraOverFields.ID,GenOperators,Boundary}",
    "page": "Terms",
    "title": "QuantumLattices.Interfaces.expand!",
    "category": "method",
    "text": "expand!(operators::Operators,ops::GenOperators,boundary::Boundary;kwargs...) -> Operators\n\nExpand the operators with the given boundary twist and term coefficients.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Terms.html#QuantumLattices.Interfaces.expand!-Tuple{Dict{I,O} where O<:Operator where I<:QuantumLattices.Mathematics.AlgebraOverFields.ID,Generator}",
    "page": "Terms",
    "title": "QuantumLattices.Interfaces.expand!",
    "category": "method",
    "text": "expand!(operators::Operators,gen::Generator) -> Operators\n\nExpand the operators of a generator.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Terms.html#QuantumLattices.Interfaces.expand-Tuple{Generator}",
    "page": "Terms",
    "title": "QuantumLattices.Interfaces.expand",
    "category": "method",
    "text": "expand(gen::Generator) -> Operators\nexpand(gen::Generator{coord},name::Symbol) where coord -> Operators\nexpand(gen::Generator,i::Int) -> Operators\nexpand(gen::Generator{coord},name::Symbol,i::Int) where coord -> Operators\n\nExpand the operators of a generator:\n\nthe total operators;\nthe operators of a specific term;\nthe operators on a specific bond;\nthe operators of a specific term on a specific bond.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Terms.html#QuantumLattices.Interfaces.reset!-Tuple{Generator,AbstractLattice}",
    "page": "Terms",
    "title": "QuantumLattices.Interfaces.reset!",
    "category": "method",
    "text": "reset!(gen::Generator,lattice::AbstractLattice) -> Generator\n\nReset a generator by a new lattice.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/Terms.html#QuantumLattices.Interfaces.update!-Tuple{Generator}",
    "page": "Terms",
    "title": "QuantumLattices.Interfaces.update!",
    "category": "method",
    "text": "update!(gen::Generator;kwargs...) -> Generator\n\nUpdate the coefficients of the terms in a generator.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Terms.html#QuantumLattices.Mathematics.AlgebraOverFields.rawelement-Tuple{Type{#s347} where #s347<:Coupling}",
    "page": "Terms",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.rawelement",
    "category": "method",
    "text": "rawelement(::Type{<:Coupling})\n\nGet the raw name of a type of Coupling.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Essentials.FockPackage.MAJORANA",
    "page": "Fock package",
    "title": "QuantumLattices.Essentials.FockPackage.MAJORANA",
    "category": "constant",
...

{
    ...
    "category": "type",
    "text": "BOperator(value,id::ID{<:Tuple{Vararg{OID}}}=ID())\n\nBosonic Fock operator.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "type",
    "text": "FOperator(value,id::ID{<:Tuple{Vararg{OID}}}=ID())\n\nFermionic Fock operator.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "type",
    "text": "FockOperator{V,I<:ID} <: Operator{V,I}\n\nAbstract type for all Fock operators.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/FockPackage.html#Base.angle-Tuple{OID{#s346,RC,IC,S} where S<:Union{Nothing, Int64} where IC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where RC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where #s346<:FIndex,AbstractArray{#s343,1} where #s343<:AbstractArray{Float64,1},AbstractArray{Float64,1}}",
    "page": "Fock package",
    "title": "Base.angle",
    "category": "method",
    "text": "angle(id::OID{<:FIndex},vectors::AbstractVector{<:AbstractVector{Float}},values::AbstractVector{Float}) -> Complex{Float}\n\nGet the twist phase corresponding to a Fock oid.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Essentials.DegreesOfFreedom.optdefaultlatex-Tuple{Type{#s347} where #s347<:BOperator}",
    "page": "Fock package",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.optdefaultlatex",
    "category": "method",
...
{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Essentials.DegreesOfFreedom.optdefaultlatex-Tuple{Type{#s347} where #s347<:FOperator}",
    "page": "Fock package",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.optdefaultlatex",
    "category": "method",
...
{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Essentials.DegreesOfFreedom.script-Tuple{OID{#s347,RC,IC,S} where S<:Union{Nothing, Int64} where IC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where RC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where #s347<:FIndex,Val{:site}}",
    "page": "Fock package",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.script",
    "category": "method",
...
{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Interfaces.:⊗-Tuple{FockCoupling,FockCoupling}",
    "page": "Fock package",
    "title": "QuantumLattices.Interfaces.:⊗",
    "category": "method",
...
{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Interfaces.permute",
    "page": "Fock package",
    "title": "QuantumLattices.Interfaces.permute",
    "category": "function",
...
{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Mathematics.AlgebraOverFields.rawelement-Tuple{Type{#s347} where #s347<:BOperator}",
    "page": "Fock package",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.rawelement",
    "category": "method",
    "text": "rawelement(::Type{<:BOperator})\n\nGet the raw name of a type of BOperator.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Mathematics.AlgebraOverFields.rawelement-Tuple{Type{#s347} where #s347<:FOperator}",
    "page": "Fock package",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.rawelement",
    "category": "method",
    "text": "rawelement(::Type{<:FOperator})\n\nGet the raw name of a type of FOperator.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/FockPackage.html#QuantumLattices.Mathematics.AlgebraOverFields.rawelement-Tuple{Type{#s347} where #s347<:FockCoupling}",
    "page": "Fock package",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.rawelement",
    "category": "method",
    "text": "rawelement(::Type{<:FockCoupling})\n\nGet the raw name of a type of FockCoupling.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "type",
    "text": "SCID(;center=wildcard,atom=wildcard,orbital=wildcard,tag=\'z\',subscript=wildcard)=SCID(center,atom,orbital,tag,subscript)\n\nThe id of a spin coupling.\n\n\n\n\n\n"
},
...

{
    ...
    "title": "QuantumLattices.Essentials.SpinPackage.SID",
    "category": "method",
    "text": "SID(;orbital::Int=1,spin::Real=0.5,tag::Char=\'z\')\n\nCreate a spin id.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "type",
    "text": "SOperator(value,id::ID{<:Tuple{Vararg{OID}}}=ID())\n\nSpin operator.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "type",
    "text": "SpinCoupling(value,id::ID{<:Tuple{Vararg{SCID}}},subscripts::Subscripts)\nSpinCoupling{N}(    value=1;\n                    tags::NTuple{N,Char},\n                    centers::Union{NTuple{N,Int},Nothing}=nothing,\n                    atoms::Union{NTuple{N,Int},Nothing}=nothing,\n                    orbitals::Union{NTuple{N,Int},Subscript,Nothing}=nothing\n                    ) where N\n\nSpin coupling.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/SpinPackage.html#QuantumLattices.Essentials.DegreesOfFreedom.optdefaultlatex-Tuple{Type{#s347} where #s347<:SOperator}",
    "page": "Spin package",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.optdefaultlatex",
    "category": "method",
...
{
    "location": "man/Essentials/SpinPackage.html#QuantumLattices.Essentials.DegreesOfFreedom.otype-Tuple{Type{#s346} where #s346<:(Term{\'B\',:SpinTerm,R,id,V,B,C,A,M} where M<:Union{Nothing, TermModulate} where A<:TermAmplitude where C<:TermCouplings where B where V where id where R),Type{#s343} where #s343<:OID}",
    "page": "Spin package",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.otype",
    "category": "method",
...
{
    "location": "man/Essentials/SpinPackage.html#QuantumLattices.Essentials.DegreesOfFreedom.script-Tuple{OID{#s347,RC,IC,S} where S<:Union{Nothing, Int64} where IC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where RC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where #s347<:SIndex,Val{:site}}",
    "page": "Spin package",
    "title": "QuantumLattices.Essentials.DegreesOfFreedom.script",
    "category": "method",
...
{
    "location": "man/Essentials/SpinPackage.html#QuantumLattices.Interfaces.permute-Tuple{Type{#s343} where #s343<:SOperator,OID{#s342,RC,IC,S} where S<:Union{Nothing, Int64} where IC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where RC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where #s342<:SIndex,OID{#s284,RC,IC,S} where S<:Union{Nothing, Int64} where IC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where RC<:Union{Nothing, SArray{Tuple{S},T,1,S} where T where S} where #s284<:SIndex,Any}",
    "page": "Spin package",
    "title": "QuantumLattices.Interfaces.permute",
    "category": "method",
    "text": "permute(::Type{<:SOperator},id1::OID{<:SIndex},id2::OID{<:SIndex},table) -> Tuple{Vararg{SOperator}}\n\nPermute two fermionic oid and get the result.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/SpinPackage.html#QuantumLattices.Mathematics.AlgebraOverFields.rawelement-Tuple{Type{#s347} where #s347<:SOperator}",
    "page": "Spin package",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.rawelement",
    "category": "method",
    "text": "rawelement(::Type{<:SOperator})\n\nGet the raw name of a type of SOperator.\n\n\n\n\n\n"
},

{
    "location": "man/Essentials/SpinPackage.html#QuantumLattices.Mathematics.AlgebraOverFields.rawelement-Tuple{Type{#s347} where #s347<:SpinCoupling}",
    "page": "Spin package",
    "title": "QuantumLattices.Mathematics.AlgebraOverFields.rawelement",
    "category": "method",
    "text": "rawelement(::Type{<:SpinCoupling})\n\nGet the raw name of a type of SpinCoupling.\n\n\n\n\n\n"
},
...
{
    "location": "man/Essentials/Extensions.html#QuantumLattices.Essentials.Extensions.@sˣ_str-Tuple{String}",
    "page": "Extensions",
    "title": "QuantumLattices.Essentials.Extensions.@sˣ_str",
    "category": "macro",
    "text": "sˣ\"sl(a)⊗ob(o)\" -> Couplings\nsʸ\"sl(a)⊗ob(o)\" -> Couplings\nsᶻ\"sl(a)⊗ob(o)\" -> Couplings\n\nThe single Sˣ/Sʸ/Sᶻ coupling.\n\n\n\n\n\n"
},
