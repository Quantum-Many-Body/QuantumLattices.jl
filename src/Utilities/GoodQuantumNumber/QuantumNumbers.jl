...
export QNSProtocol,qnscounts,qnsindptr,QuantumNumbers,regularization
...
"""
    QuantumNumbers(form::Char,::Type{QN},contents::Array{Float64,2},info::Array{Int64,1},protocol::QNSProtocol=qnscounts) where QN<:QuantumNumber
    QuantumNumbers(form::Char,contents::Array{QN,2},info::Array{Int64,1},protocol::QNSProtocol=qnscounts) where QN<:QuantumNumber
...
struct QuantumNumbers{QN<:QuantumNumber}
    ...
    function QuantumNumbers(form::Char,::Type{QN},contents::Array{Float64,2},info::Array{Int64,1},protocol::QNSProtocol=qnscounts) where QN<:QuantumNumber
...
QuantumNumbers(form::Char,contents::Array{QN,2},info::Array{Int64,1},protocol::QNSProtocol=qnscounts) where QN<:QuantumNumber=QuantumNumbers(form,QN,hcat([[qn.values...] for qn in contents]...),info,protocol)
