...
export bonds, bonds!, fractionals, icoordinate, iscontinuous, isdiscrete, isintracell, label, rcoordinate, savedlm, selectpath, shrink, ticks, @hexagon_str, @line_str, @rectangle_str
