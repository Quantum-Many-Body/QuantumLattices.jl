...
In previous pages, we have introduced in detail the essential elements of a quantum lattice system in the unitcell description framework. In this page, we will discuss how these elements can be combined to obtain the operator representation of the lattice Hamiltonian.

## Operator-formed lattice Hamiltonians

**The essential elements to obtain an operator-formed lattice Hamiltonian are: 1) bonds, 2) terms, and 3) Hilbert space**.

Accordingly, [`OperatorGenerator`](@ref) is the type that incorporates all these elements:
```julia
...
```
This is based on the expansion of terms introduced in the last section of the previous page [Couplings among different degrees of freedom](@ref).
