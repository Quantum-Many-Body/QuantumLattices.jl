...
⊗(m1::BasicOperator,m2::BasicOperator)=m1*m2
...
@testset "Elements" begin
    ...
    @test opt1*opt2==opt1⊗opt2==BasicOperator(2.0,ID(SMPID(1,1),SMPID(1,2)))
    @test opts*opt3==opts⊗opt3==Elements(BasicOperator(3.0,ID(SMPID(1,1),SMPID(1,3))),BasicOperator(6.0,ID(SMPID(1,2),SMPID(1,3))))
    @test opt3*opts==opt3⊗opts==Elements(BasicOperator(3.0,ID(SMPID(1,3),SMPID(1,1))),BasicOperator(6.0,ID(SMPID(1,3),SMPID(1,2))))
    @test opts*Elements(opt3)==opts⊗Elements(opt3)==Elements(BasicOperator(3.0,ID(SMPID(1,1),SMPID(1,3))),BasicOperator(6.0,ID(SMPID(1,2),SMPID(1,3))))
end
